...
export const freelanceServices: FreelanceService[] = [
  {
    ...
    proofs: [
      { label: "API automation proof pack", href: "https://github.com/Emeraude-Kiangana/open-technologies-portfolio/tree/main/proofs/freelance/api-automation" },
      { label: "Service proof workflow", href: "https://github.com/Emeraude-Kiangana/open-technologies-portfolio/actions/workflows/freelance-service-proofs.yml" },
      { label: "KIF provider/fallback evidence", href: "https://github.com/Emeraude-Kiangana/kiangana-2.0" },
    ],
    limitations: ["La preuve publique utilise deux API HTTP locales factices; une intégration client spécifique doit être testée sur son contrat réel."],
  },
  {
    slug: "github-setup",
    title: "GitHub Setup",
  ...
  },
  {
    ...
    proofState: "PUBLIC PROOF",
    proofs: [
      { label: "Dockerization proof pack", href: "https://github.com/Emeraude-Kiangana/open-technologies-portfolio/tree/main/proofs/freelance/dockerization" },
      { label: "Service proof workflow", href: "https://github.com/Emeraude-Kiangana/open-technologies-portfolio/actions/workflows/freelance-service-proofs.yml" },
    ],
    limitations: ["La preuve couvre build, runtime non-root, Compose, health check et smoke test; elle ne prouve pas Kubernetes ni un déploiement cloud de production."],
  },
  {
    ...
    proofState: "PUBLIC PROOF",
    proofs: [
      { label: "Backend prototype proof pack", href: "https://github.com/Emeraude-Kiangana/open-technologies-portfolio/tree/main/proofs/freelance/backend-prototype" },
      { label: "Service proof workflow", href: "https://github.com/Emeraude-Kiangana/open-technologies-portfolio/actions/workflows/freelance-service-proofs.yml" },
      { label: "P01 support API adapter", href: "https://github.com/Emeraude-Kiangana/open-technologies-portfolio/tree/main/support-api" },
    ],
    limitations: ["La preuve publique couvre une API HTTP bornée avec OpenAPI, validation et tests; elle ne revendique ni base persistante ni déploiement production."],
  },
  {
